...
export default class SourceHeader extends WebComponent {
  ...
  render () {
    return html`
      <header class="sourcePaneHeader">
        <div class="sourcePaneHeaderInfo">
          <span class="sourcePaneIcon">${sourcePaneIcon}</span>
          <div class="">
            <p>Name of file</p>
            <div>
            <p>by Person date icon public/private</p>
            </div>
          </div>
        </div>
        <div class="sourcePaneControls">
